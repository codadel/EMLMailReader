...
class TestTextEncoding(unittest.TestCase):
    def test_header_decoder_handles_adjacent_and_mixed_words(self):
    ...
    def test_header_decoder_replaces_invalid_bytes(self):
        value = "=?ascii?b?/w==?="
        self.assertEqual(TextEncoding.decode_header(value), "�")

    def test_base64_text_and_file_decoders(self):
    ...
    def test_quoted_printable_decoder(self):
        self.assertEqual(
