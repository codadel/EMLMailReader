...
### Core Classes
- [**MailReader**](./docs/MailReader.md) - Primary EML file parser
- [**RxMailMessage**](./docs/RxMailMessage.md) - Complete email message representation

### Address and Attachment Classes
- [**MailAddress**](./docs/MailAddress.md) - Individual email address representation
- [**MailAddressCollection**](./docs/MailAddressCollection.md) - Collection of email addresses
- [**MailAttachment**](./docs/MailAttachment.md) - Individual email attachment
- [**MailAttachmentCollection**](./docs/MailAttachmentCollection.md) - Collection of attachments

### MIME Header Classes
- [**ContentType**](./docs/ContentType.md) - MIME Content-Type header handling
- [**ContentDisposition**](./docs/ContentDisposition.md) - MIME Content-Disposition header handling

### Utility Classes
- [**TextEncoding**](./docs/TextEncoding.md) - Text encoding and decoding utilities
- [**Logger**](./docs/Logger.md) - Logging configuration and management

### Supporting Classes
- [**Enumerations**](./docs/Enumerations.md) - Library enumerations and constants
- [**Exceptions**](./docs/CustomExceptions.md) - Library-specific exception classes
